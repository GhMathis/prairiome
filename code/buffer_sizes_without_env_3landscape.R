...
st_read("data/shapefiles/sql_statement_d551600.shp")  %>% 
  ...
  mutate(lib = case_when(
    ...
    lib4_16 %in% c("Prairie naturelle","Coussoul", "Dune embryonnaire",                         
                   "Dune végétalisée", "Dune à végétation arbustive","Marais ouvert",
                   "Feuillu", "Formation arbustive et arborée semi-ouverte", "Ripisylve",
                   "Conifère",  "Formation arbustive et arborée fermée","Plage",
                   "Etang et/ou lagune", "Canal", "Forêt mélangée",
                   ...
                   "Lagune de pré-concentration", "Table saunante", "Friche salicole récente" ) ~ "natural",
